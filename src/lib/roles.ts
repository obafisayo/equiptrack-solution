...
export const ROLE_META: Record<string, RoleMeta> = {
  ...
  safety: {
    ...
    dept: 'HSE',
    deptColor: '#EF4444',
    description: 'Monitor safety incidents, conduct equipment inspections, and enforce HSE standards across operations.',
    capabilities: [
      'Log and track safety incidents',
      'Review equipment inspection status',
      'Flag non-compliant work orders',
      'Generate HSE compliance reports',
    ],
    demoEmail: 'aisha.musa@demo.equiptrack.io',
    demoPassword: 'Safety#Demo2024',
    dashboardPath: '/safety',
  },
  logistics: {
    slug: 'logistics',
